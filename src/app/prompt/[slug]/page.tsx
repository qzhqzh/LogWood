...
export default async function PromptDetailPage({ params }: TargetPageProps) {
  ...
  return (
    <main className="min-h-screen bg-[#0a0a0f] grid-bg relative">
      <nav className="border-b border-pink-500/20 bg-[#0a0a0f]/80 backdrop-blur-xl sticky top-0 z-50">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="flex justify-between h-16 items-center">
            <Link href="/" className="text-2xl font-bold font-['Orbitron'] gradient-text">LogWood</Link>
            <div className="flex items-center gap-6">
              <Link href="/coding?category=prompt" className="text-pink-300 font-medium tracking-wide">AI Prompt</Link>
